...
class FaceIdAuthentication {
    ...
    func handlePermission(completion: ((Bool) -> ())) {
        var error: NSError?
...
class BiometricIDAuth {
    ...
    init(policy: LAPolicy = .deviceOwnerAuthenticationWithBiometrics, localizedReason: String = "Verify your Identity",  localizedFallbackTitle: String = "Enter Device Password", localizedCancelTitle: String = "Cancel") {
        self.policy = policy
